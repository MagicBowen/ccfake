#ifndef CCFAKE_DFC06E37388347EFA7F273C87D61B320
#define CCFAKE_DFC06E37388347EFA7F273C87D61B320

#include "ccfake/log/log_color.h"
#include "ccfake/base/enum.h"
...
#define EG_LOG_LEVEL_STRING(LEVEL)         	\
	case LogLevel::LEVEL  : return #LEVEL

#define EG_LOG_LEVEL_COLOR(LEVEL, COLOR)   	\
	case LogLevel::LEVEL  : return to_color_fmt(LogColor::COLOR)
...
constexpr bool level_enabled(LogLevel level) {
    constexpr unsigned int enabled_levels =
              enum_underlying_cast(LogLevel::FATAL)
